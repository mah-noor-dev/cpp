...
void additem(string name, int price) {
    ...
    cout << "added item " << name << " into doubly" << endl;
}
...
void insertitembefore(string targetname, string newname, int price) {
    ...
    if (temp != NULL) {
        ...
        cout << "added item " << newname << " before " << targetname << endl;
    }
}
...
void displayforward() {
    cout << "lets display forward : " << endl;
    Node* temp1 = head;
    while (temp1 != NULL) {
...
void displaybackward() {
    cout << "lets display backward : " << endl;
    Node* temp2 = tail;
    while (temp2 != NULL) {
        cout << temp2->name << "  Rs." << temp2->price << endl;
        temp2 = temp2->prev;
    }
    cout << endl;
}
